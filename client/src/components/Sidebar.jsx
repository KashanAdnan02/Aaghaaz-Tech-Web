            ...
            <div className={`fixed top-0 left-0 h-full bg-white shadow-lg z-50 transition-all duration-300 ease-in-out 
                ...
                <div className="flex flex-col h-full">
                    ...
                    <div className="flex items-center justify-between h-16 border-b px-4">
                        <span className={`text-xl font-bold text-blue-600 transition-opacity duration-300 ${!isOpen && 'lg:opacity-0'}`}>
                            Student MS
                        </span>
                    ...
                    {/* User Profile Card - at the top after logo */}
                    <div className={`p-4 border-b bg-gray-50 transition-opacity duration-300 ${!isOpen && 'lg:opacity-0'}`}>
                        <div className="flex items-center">
                            <div className="w-10 h-10 rounded-full bg-blue-500 flex items-center justify-center text-white font-semibold">
                                {userInitial}
                            </div>
                            <div className={`ml-3 transition-opacity duration-300 ${!isOpen && 'lg:opacity-0'}`}>
                            ...
                            {navItems.map((item) => (
                                <li key={item.name}>
                                    {item.children ? (
                                        ...
                                        <Link
                                            to={item.path}
                                            className={`flex items-center px-4 py-3 text-sm font-medium transition-colors duration-150 rounded-md ${
